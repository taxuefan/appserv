...
public class CacheManager {
    ...
    private final static ConcurrentHashMap<Object, CacheEntry> cacheEntryMap = new ConcurrentHashMap<>();
    ...
    /**
     * @Author taxuefan
     * @Description //通过内部类实现，单例模式
     * @Date 20:39 2020/10/12
     * @Param []
     * @return com.hs.edu.app.cache.CacheManager
     **/
